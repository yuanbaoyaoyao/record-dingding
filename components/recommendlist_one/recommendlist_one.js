Component({
  ...
  didUpdate() {
    this.setData({
      ...
      busPos: this.props.cartPos,
      hideCount: this.props.hideCount,
      count: this.props.count,
      needAni: this.props.needAni,
      hide_good_box: this.props.hide_good_box
    })
  },
  didUnmount() { },
  methods: {
    ...
    getCartPos: function () {
      ...
      my.getSystemInfo({
        ...
        success: function (res) {
          ...
          busPos['x'] = cartWidth + 15
          busPos['y'] = screenHeight - cartHeight
          console.log("购物车坐标：", busPos)
    ...
    touchOnAdd: function (e) {
      ...
      console.log("点击时的坐标：", finger)
      topPoint['x'] = e.detail.clientX - 150
      topPoint['y'] = e.detail.clientY - 150
      ...
      //计算出贝塞尔曲线运动位置数组
      // let linePos = this.bezier([finger, topPoint, this.data.busPos], 30);
